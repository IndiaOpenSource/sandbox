...
function myvastra_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['mtt_settings']['tabs'] = array(
    '#type' => 'vertical_tabs',
    '#attached' => array(
      'css' => array(drupal_get_path('theme', 'myvastra') . '/myvastra.settings.form.css'),
    ),
  );
 ...
 $form['mtt_settings']['tabs']['responsive_menu']['responsive_select_menu']['responsive_menu_switchwidth'] = array(
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_js'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_js','myvastra'),
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_latitude'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_latitude','myvastra'),
    '#size' => 5,
    '#maxlength' => 10,
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_longitude'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_longitude','myvastra'),
    '#size' => 5,
    '#maxlength' => 10,
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_zoom'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_zoom','myvastra'),
    '#size' => 5,
    '#maxlength' => 10,
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_canvas'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_canvas','myvastra'),
  );
