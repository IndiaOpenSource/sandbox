 ...
 */
function myvastra_breadcrumb($variables){
 ...
 */
function myvastra_preprocess_block(&$variables) {
 ...
 */
function myvastra_preprocess_html(&$variables) {
	...
	*/
	...
	if (theme_get_setting('responsive_menu_state')) {
        ...
        drupal_add_js(array('myvastra' => array('topoptiontext' => $responsive_menu_topoptiontext)), 'setting');
		$responsive_menu_nested = theme_get_setting('responsive_menu_nested');
		...
		$("#main-navigation ul.main-menu, #main-navigation .content>ul.menu").mobileMenu({
            ...
            topOptionText: Drupal.settings.myvastra[\'topoptiontext\']
		});
	...
	if (theme_get_setting('google_map_js')) {
        ...
        drupal_add_js(array('myvastra' => array('google_map_latitude' => $google_map_latitude)), 'setting');
		$google_map_longitude = theme_get_setting('google_map_longitude');
        drupal_add_js(array('myvastra' => array('google_map_longitude' => $google_map_longitude)), 'setting');
		$google_map_zoom = (int) theme_get_setting('google_map_zoom');
		$google_map_canvas = theme_get_setting('google_map_canvas');
        drupal_add_js(array('myvastra' => array('google_map_canvas' => $google_map_canvas)), 'setting');
 ...
 * Override or insert variables into the html template.
 */
function myvastra_process_html(&$vars) {
 ...
 */
function myvastra_preprocess_page(&$variables) {
...
*/
function myvastra_preprocess_maintenance_page(&$variables) {
...
function myvastra_page_alter($page) {
...
function myvastra_form_alter(&$form, &$form_state, $form_id) {
