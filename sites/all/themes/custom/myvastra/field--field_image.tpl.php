...
<?php
drupal_add_js(drupal_get_path('theme', 'myvastra') .'/js/magnific-popup/jquery.magnific-popup.js', array('preprocess' => false));
drupal_add_css(drupal_get_path('theme', 'myvastra') . '/js/magnific-popup/magnific-popup.css');
